#Ahora que ya sabemos construir una interacción básica con nuestro programa
#de red social, vamos a agregar nuevas funcionalidades.
#
#Partiremos con el mismo programa de la etapa anterior, que permite dos cosas:
...
#Para empezar vamos a permitir que el usuario publique todos los mensajes que considere hasta
...
print()
print("Hola ", nombre, ", bienvenido a redPCP")
print()
...
print("--------------------------------------------------")
print("Gracias por la información. Esperamos que disfrutes con redPCP")
print()
...
print("Gracias por usar redPCP. ¡Hasta pronto!")

#Ahora puedes escribir mensajes todas las veces que quieras.
#Observa que hemos utilizado un ciclo while que permite repetir la acción de preguntar por un mensaje
...
#Para completar esta actividad debes:
...
#
#2. Desarrolla un menú que le permita al usuario realizar más de una acción.
#   Por ejemplo, puedes agregar una acción que permita al usuario modificar su nombre.

#*** Puedes realizar la actividad en este archivo, sin embargo será más interesante actualizar tu
#    propio proyecto de red social (el que hiciste en el laboratorio 3), pues este irá creciendo a medida que
#    avance el curso.