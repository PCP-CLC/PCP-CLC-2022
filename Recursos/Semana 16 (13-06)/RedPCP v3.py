...
#con un print por cada dato. El código se verá como está más abajo.
...
print()
print("Gracias por usar Red PCP. ¡Hasta pronto!")
print()
...
#Esto lo podemos hacer, talvez sin cometer errores, en un programa pequeño como este.
...
#Para completar esta actividad debes convertir 3 aspectos/funcionalidades de este programa en funciones.
#Recuerda que si tienes tu propia red, es mejor que trabajes en ella y seguir haciendola crecer.