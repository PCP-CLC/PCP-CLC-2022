...
class Application(tk.Tk):
    ...
    def inicia_juego(self):
        ...
        while index > 0  :
            ...
            index-=1
        if 0 in lista_aleatoria: a = 2
        if 1 in lista_aleatoria: b = 2
        if 2 in lista_aleatoria: c = 2
        if 3 in lista_aleatoria: d = 2
        if 4 in lista_aleatoria: e = 2
        if 5 in lista_aleatoria: f = 2
        if 6 in lista_aleatoria: g = 2
        if 7 in lista_aleatoria: h = 2
        if 8 in lista_aleatoria: i = 2
        if 9 in lista_aleatoria: j = 2
        if 10 in lista_aleatoria: k = 2
        if 11 in lista_aleatoria: l = 2
        if 12 in lista_aleatoria: m = 2
        if 13 in lista_aleatoria: n = 2
        if 14 in lista_aleatoria: o = 2
        if 15 in lista_aleatoria: p = 2
